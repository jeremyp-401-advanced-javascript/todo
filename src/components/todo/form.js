      ...
      <Card.Body>
        <Form onSubmit={_submitForm}>
          <Form.Group>
            ...
            <Form.Control data-testid="textInput" 
              name="text" placeholder="Item Details" onBlur={_changeInput} />
            </Form.Label>
          </Form.Group>
          <Form.Group>
            <Form.Label>Assigned To:
            <Form.Control type="text" data-testid="assigneeInput" 
              name="assignee" placeholder="Assignee Name" onBlur={_changeInput} />
            </Form.Label>
          </Form.Group>
          <Form.Group>
            <Form.Label>Difficulty Rating:
            <Form.Control type="range" data-testid="difficultyInput" 
              name="difficulty" defaultValue="1" min="1" max="5" custom onBlur={_changeInput} />
            </Form.Label>
          </Form.Group>
